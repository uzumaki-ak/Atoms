  ...
  return (
    <CardContainer className={className}>
      <CardBody className="bg-black/80 backdrop-blur-sm relative group/card hover:shadow-2xl hover:shadow-sky-500/10 border-sky-500/30 w-full sm:w-[30rem] h-full rounded-2xl p-6 border transition-all duration-300">
        ...
        {/* Project Images (first image as thumbnail or fallback) */}
        {project.projectImages && project.projectImages.length > 0 ? (
          ...
          <CardItem
            ...
            className="w-full mb-6"
          >
            <div className="relative aspect-video rounded-xl flex items-center justify-center border border-dashed border-gray-600 bg-gray-900">
...
// export const ProjectCard = ({ project, className }: ProjectCardProps) => {
//   return (
//     <CardContainer className={`h-full ${className || ''}`}>
//       <CardBody className="bg-black/80 backdrop-blur-sm relative group/card hover:shadow-2xl hover:shadow-sky-500/10 border-sky-500/30 w-full sm:w-[30rem] h-full flex flex-col rounded-2xl p-6 border transition-all duration-300">
//         {/* Project Header with Gradient */}
//         <CardItem
//           translateZ="50"
